...
public static void main(String[] args) {
	...
	saturn.orbitalDistance = 1427000000;
	saturn.distanceFromSun = 923510000;
	saturn.surfaceArea = 16490000000;
	saturn.lengthOfDay = 11;
	saturn.radius = 36184;
	saturn.hasRings = true;

	Homework83_Planets uranus = new Homework83_Planets();
	uranus.orbitalDistance = 2750000000;
	uranus.distanceFromSun = 1835100000;
	uranus.surfaceArea = 3121000000;
	uranus.lengthOfDay = 17;
	uranus.radius = 15759;
	uranus.hasRings = true;

	Homework83_Planets neptune = new Homework83_Planets();
	mercury.orbitalDistance = 4500000000;
	mercury.distanceFromSun = 2780800000;
	mercury.surfaceArea = 2941000000;
	mercury.lengthOfDay = 16;
	mercury.radius = 15299;
